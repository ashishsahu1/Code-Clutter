...
int countHor(vector<vector<int>> inp){
    int c=0;
    if(inp[0][0]-inp[0][1] == inp[0][1]-inp[0][2]){
        c++;
    }
    if(inp[1][0]-inp[1][1] == inp[1][1]-inp[1][2]){
        c++;
    }
    if(inp[2][0]-inp[2][1] == inp[2][1]-inp[2][2]){
        c++;
    }
    return c;
}
...
int countVer(vector<vector<int>> inp){
    int c=0;
    if(inp[0][0]-inp[1][0] == inp[1][0]-inp[2][0]){
        c++;
    }
    if(inp[0][1]-inp[1][1] == inp[1][1]-inp[2][1]){
        c++;
    }
    if(inp[0][2]-inp[1][2] == inp[1][2]-inp[2][2]){
        c++;
    }
    return c;
}
